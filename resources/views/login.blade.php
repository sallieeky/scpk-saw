...
<head>
  ...
  <title>Login - Beasiswa Balikpapan Tuntas</title>
  <!-- Google font-->
        ...
        <div class="col-12">
          <div class="login-card">
            <form class="theme-form login-form" method="POST" action="/login">
              @csrf
              <h4>Login</h4>
              <h6>Login dulu yuk sebelum mendaftar atau mengecek <br><b>Beasiswa Balikpapan Tuntas</b>.</h6>
              ...
              <div class="d-flex" style="justify-content: space-between; align-items: baseline">
                <label><a href="/daftar">Belum memiliki akun?</a></label>
                <div class="form-group">
