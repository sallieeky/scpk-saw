...
<head>
  ...
  <title>Daftar Akun - Beasiswa Balikpapan Tuntas</title>
  <!-- Google font-->
      ...
      <div class="row">
        <div class="col-12">
          <div class="login-card">
            <form class="theme-form login-form" method="POST" action="/daftar">
              @csrf
              <h4>Daftar Akun</h4>
              <h6>Buat akun terlebih dahulu yuk sebelum login untuk mendaftar <br><b>Beasiswa Balikpapan Tuntas</b>.</h6>
              <div class="form-group">
                <label>Email</label>
                <div class="input-group"><span class="input-group-text"><i class="icon-email"></i></span>
                  <input class="form-control" type="email" name="email" required placeholder="mail@gmail.com">
                </div>
                @error("email")
              ...
              <div class="form-group">
                ...
                <div class="input-group"><span class="input-group-text"><i class="icon-lock"></i></span>
                  <input class="form-control" type="password" name="password_validate" required placeholder="*********">
                  <div class="show-hide"><span class="show"></span></div>
                </div>
              </div>
              @if(session('error'))
